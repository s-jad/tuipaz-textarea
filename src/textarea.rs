...
impl<'a> Default for TextArea<'a> {
    fn default() -> Self {
        Self::new(vec![String::new()], HashMap::new())
    }
}
...
impl<'a> TextArea<'a> {
    ...
    /// ```
    pub fn new(mut lines: Vec<String>, links: HashMap<usize, Link>) -> Self {
        if lines.is_empty() {
    ...
    fn delete_piece(&mut self, col: usize, chars: usize) -> bool {
        ...
        if let Some((i, _)) = line.char_indices().nth(col) {
            ...
            self.shift_links_after_delete((row, start_col), (row, col));
    ...
    pub fn delete_line(&mut self, shift_up: bool) -> bool {
        ...
        self.shift_links_after_delete((row + 1, 0), (row, 0));
    ...
    pub fn delete_char(&mut self) -> bool {
        ...
        self.shift_links_after_delete((row, col), delete_pos);
    ...
    fn delete_selection(&mut self, should_yank: bool) -> bool {
        ...
        if let Some((s, e)) = self.take_selection_range() {
            ...
            self.shift_links_after_delete((e.row, e.col), (s.row, s.col));
